<script setup lang="ts">
    ...
    const form = reactive({id:0,cate_id:'',title:'',keyword:'',desc:'',pic:'',picture:[] as UploadList[],start_time:'',end_time:'',is_original:0,source_url:'',is_comment:0,content:'',sort:1})
...
<template>
    ...
    <el-container class="w-screen h-screen overflow-auto bg-white p-10">
        <el-form ref="ruleFormRef" :model="form" size="large" :label-width="formLabelWidth">
            ...
            <el-form-item label="">
                <el-col :span="16">
                    <el-upload :action="uploadAction+'?path=activity'" :file-list="pictures" list-type="picture-card" :on-success="uploadSuccess">
